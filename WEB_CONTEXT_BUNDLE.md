...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-019"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-v1",
      "problem_contract_sha256": "f0ca890b7943279b9727a350cdcb193a5e5ee1c8cd2914e0a60d61879c3570f2",
      "problem_id": "problem:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda",
      "route_id": "route:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-source-fidelity-01",
      "graph_id": "graph:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there infinitely many primes $p$ such that $2p + 1$ is also prime?"
          },
          "statement_sha256": "0b6c081bd75808c0a9b3ac551b5054633b7f10f62a066780849d7c9d82ec6d1a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-root",
      "route_id": "route:um-nt-019-are-there-infinitely-many-sophie-germa-56f4fcda-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-019-92bdb60a38d0",
        "url": "https://www.unsolvedmath.com/problems/NT-019"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
